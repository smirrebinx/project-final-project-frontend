...
const WelcomePage = () => {
  ...
  const userReviews = [
    <span>
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 1792 1792" role="img" fill="black" className="fa-icon" aria-label="Icon depicting quote-left">
        <path d="M832 960v384q0 80-56 136t-136 56h-384q-80 0-136-56t-56-136v-704q0-104 40.5-198.5t109.5-163.5 163.5-109.5 198.5-40.5h64q26 0 45 19t19 45v128q0 26-19 45t-45
